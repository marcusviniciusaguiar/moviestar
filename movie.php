  ...
  <div id="main-container" class="container-fluid">
    <div class="row">
        <div class="offset-md-1 col-md-6 movie-container">
            ...
            <iframe src="<?= $movie->trailer ?>" width="560" height="315" frameborder="0" aloow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        ...
        <div class="offset-md-1 col-md-10" id="reviews-container">
          ...
          <!-- Verifica se habilita a review para o usuário ou não -->
           ...
           <div class="col-md-12" id="review-form-container">
            ...
            <p class="page-description">Preencha o formulário com a sua opinião sobre o filme</p>
